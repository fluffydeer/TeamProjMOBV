...
class PlayerViewAdapter {
    ...
    companion object{
        ...
        fun pauseCurrentPlayingVideo() : Boolean{
        ...
        fun pauseResume(){
            if (currentPlayingVideo != null) {
                if(currentPlayingVideo?.second?.playWhenReady == true){
                    currentPlayingVideo?.second?.playWhenReady = false
                }
                else if (currentPlayingVideo?.second?.playWhenReady == false){
        ...
        * */
        @JvmStatic
        @BindingAdapter(value = ["video_url", "on_state_change", "progressbar", "item_index"], requireAll = false)
        fun PlayerView.loadVideo(url: String, callback: PlayerStateCallback, progressbar: ProgressBar, item_index: Int? = null) {
            if (url == null) return
