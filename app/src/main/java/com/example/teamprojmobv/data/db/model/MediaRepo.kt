...
//    public fun getMediaData(): MutableLiveData<MutableList<MediaItem>> {
//        val data: MutableLiveData<MutableList<MediaItem>> = MutableLiveData()
//        val dataObservable = Observable.create<MutableList<MediaItem>> {
//            it.onNext(
//                mutableListOf(
//                    MediaItem(
////                        1,
