...
import com.example.teamprojmobv.databinding.VideoItemRecyclerBinding
import com.example.teamprojmobv.data.db.model.MediaItem
import com.example.teamprojmobv.data.util.PlayerStateCallback
...
class VideoRecyclerAdapter(
    ...
    private var modelList: ArrayList<MediaItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>(), PlayerStateCallback {
    private var mItemClickListener: OnItemClickListener? = null

    fun updateList(modelList: ArrayList<MediaItem>) {
        val pom3 = modelList.get(1).videourl
    ...
    override fun onCreateViewHolder(
        ...
        val binding: VideoItemRecyclerBinding = DataBindingUtil.inflate(LayoutInflater.from(viewGroup.context)
            , R.layout.video_item_recycler, viewGroup, false
        )
    ...
    inner class VideoPlayerViewHolder(private val binding: VideoItemRecyclerBinding) :
        ...
        fun onBind(model: MediaItem) {
            ...
            binding.apply {
                dataModel = model
                callback = this@VideoRecyclerAdapter
